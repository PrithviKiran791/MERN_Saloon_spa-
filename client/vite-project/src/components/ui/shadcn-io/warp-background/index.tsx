...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  const generateBeams = useCallback(() => {
    if (!isClient) {
      // Return deterministic beams for SSR
      const beams = [];
  ...
  return (
    <div className={cn("relative rounded border p-20", className)} {...(props as any)}>
      <div
        style={
          {
